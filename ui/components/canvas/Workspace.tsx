 ...
 * `Mask { segment }`). Mutations (text-block add/delete and mask edits)
 * dispatch through `applyCommand` or the V2 mask
...
export function Workspace() {
  ...
  const maskPointerEnabled = mode === 'repairBrush' || mode === 'eraser'
