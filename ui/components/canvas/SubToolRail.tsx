...
export function SubToolRail() {
  ...
  return (
    <div
      className='absolute top-14 left-11 z-50 ml-1 flex w-[260px] flex-col overflow-hidden rounded-xl border border-border bg-card shadow-2xl transition duration-200 ease-out'
