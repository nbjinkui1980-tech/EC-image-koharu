...
| AR13-T02 破坏性 Project ID 精确匹配 | 🚧 | — | L-AR13B 在途,合同 `62660665` |
| AR13-T03 Mask 复用 generated API | 🚧 | — | L-AR13B 在途 |
| AR13-T04 Export 保留 filename | 🚧 | — | L-AR13B 在途 |
...
|---|---|---|---|---|
| L-AR13B | Sisyphus/ulw(当前会话) | `audit-remediation-phase3` | `6266066571e96275` | 2026-08-14 |
