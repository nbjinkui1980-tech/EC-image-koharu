...
| **P4** | **L-AR10** 发布 provenance | AR10-T01 → T02 → T03 | 解锁 AR14-T06;仅本地修改/验证 | ✅ 收口(2026-08-15) |
...
| AR10-T01 Actions 固定完整 SHA | ✅ | commit `051ecea9` | L-AR10 收口证据见合同 |
| AR10-T02 Release 最小权限/签名 digest | ✅ | commit `138237e0` | ←T01;L-AR10 收口证据见合同 |
| AR10-T03 同 run artifact/Docker provenance | ✅ | commit `4b8c5caa` | ←T02;Docker build 环境阻塞记录;L-AR10 收口证据见合同 |
...
| AR11-T04 Auto-render project/page 隔离 | ✅ | commit `0fa9b34f` | L-AR11 收口证据见合同 |
| AR11-T05 Scene 临时错误保留旧数据 | ✅ | commit `4aa36a36` | L-AR11 收口证据见合同 |
| AR11-T06 Verification URL allowlist | ✅ | commit `944915d6` | L-AR11 收口证据见合同 |
| AR12-T01 Query 缓存 bytes,组件拥有 URL | ✅ | commit `ac980ef1` | L-AR12 收口证据见合同 |
| AR12-T02 FontFace owner | ✅ | commit `3b7dc13f` | L-AR12 收口证据见合同 |
| AR12-T03 UI jobs/downloads retention | ✅ | commit `b02c57bf` | L-AR12 收口证据见合同 |
| AR12-T04 Updater cleanup | ✅ | commit `31fa3a1a` | L-AR12 收口证据见合同 |
| AR12-T05 文本输入原生 undo/redo | ✅ | commit `37fcfa0c` | L-AR12 收口证据见合同 |
| AR12-T06 字体收藏与删除按钮 a11y | ✅ | commit `769fb1ae` | L-AR12 收口证据见合同 |
...
| W3 | **PASS** | `48e30941` | Sisyphus/K3,2026-08-15;W3 卡全 ✅(AR01-T00~T03/AR03/AR04-T02~T03);app 465P/0F(两次)、rpc 46P/0F、llm 40P/0F;credential matrix/redirect/history fault injection 均在上述 suite 内;过程一次 app suite 2F 瞬态(未捕获具体名,连续两次复跑全绿,符合 hanonly 合同族既有 flake 模式,记录) |
...
| 2026-08-15 | — | W3 波次重估后标 PASS | W3 卡(AR01-T00~T03/AR03-T01~T03/AR04-T02~T03)早已全 ✅,门禁复核:app 465P/0F×2、rpc 46P/0F、llm 40P/0F;一次 2F 瞬态(未捕获具体名,复跑全绿,既有 flake 模式);波次全景:W2/W3/W4/W5 PASS,W1 差 T07 ◐(环境阻塞),W6 差 T07 ◐;FINAL-T01/T02 维持 🔴(W1/W6 未 PASS + 凭据门禁) |
